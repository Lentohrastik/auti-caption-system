    ...
    async def cmd_add(self, message: types.Message):
        ...
        if get_team['status'] == 'success':
            if get_team['data'] is None:
                ...
                await message.reply("Введи данные человека в формате: Имя Фамилия-Роль (e.g. Иванов Иван Иванович-Программист или Иванов И. И.-программист)",
                                    reply_markup=inline_menu)
        ...
        if check_name['status'] == 'success':
            if check_name['data']:
                ...
                await message.answer(
                    "Неверный формат! Введи данные человека в формате: Имя Фамилия-Роль (e.g. Иванов Иван Иванович-Программист или Иванов И. И.-программист)",
                    reply_markup=inline_menu)
        else:
    ...
    async def callback_cancel(self, callback: types.CallbackQuery, state: FSMContext):
        if callback.data == 'cancel':
            ...
            await callback.answer(
                "А теперь введи данные человека в формате: Имя Фамилия-Роль (e.g. Иванов Иван Иванович-Программист или Иванов И. И.-программист)")
